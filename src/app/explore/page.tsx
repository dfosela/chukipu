...
export default function ExplorePage() {
    ...
    useEffect(() => {
        ...
        const unsubscribePlans = onValue(plansRef, (snapshot) => {
            if (snapshot.exists()) {
                ...
                setPublicPlansByCategory({ __raw__: allPlans } as any);
            } else {
    ...
    useEffect(() => {
        ...
        const raw = (publicPlansByCategory as any).__raw__;
        if (!raw) return;
    ...
    const handleRate = async (id: string, rating: number) => {
        ...
        try {
            ...
            await firebaseBatchUpdate({
                ...
                [`chukipus/${id}/ratings/${user.uid}`]: { rating, createdAt: Date.now() },
            });
    ...
    return (
        <div className={styles.container}>
            ...
            <header className={styles.header}>
                ...
                <button className={styles.notificationBtn} onClick={() => router.push('/notifications')} aria-label="Notificaciones">
                                                ...
                                                <div className={styles.exploreScrollContainer}>
                                                    {publicPlansByCategory[category].map(plan => (
                                                        <div
                                                            ...
                                                            onClick={() => router.push(`/chukipus/${plan.chukipuId}/plans/${plan.id}`)}
                                                        >

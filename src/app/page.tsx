      ...
      <main className={`${styles.main} ${isEmpty && !hasRecommended && !loading ? styles.mainEmpty : ''}`}>
        {loading || authLoading ? (
          ...
          <div className={styles.emptyState}>
            ...
            <button className={`btn btn-primary ${styles.emptyBtn}`} onClick={() => router.push('/chukipus/new')}>
              Crear Chukipu
            </button>
          </div>
        ) : (
            ...
            {!isEmpty && nextPlan && (
              <>
                ...
                <div className={styles.nextPlanCard}
                  onClick={() => router.push(`/chukipus/${nextPlan.chukipuId}/plans/${nextPlan.id}`)}
                >
                      ...
                      <div className={styles.recommendedScrollContainer}>
                        {plans.map(plan => (
                          <div key={plan.id} className={styles.recommendedCardWrapper}>
                            <div className={styles.nextPlanCard} onClick={() => router.push(`/chukipus/${plan.chukipuId}/plans/${plan.id}`)}>

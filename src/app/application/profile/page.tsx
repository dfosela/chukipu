        ...
        return (
            <button className={styles.gridItem} onClick={onClick}>
                <div className={styles.collage1} style={{ position: 'relative' }}>
                    <Image src={firstPhoto!} alt="" className={styles.colImg} fill style={{ objectFit: 'cover' }} />
                </div>
            </button>
        );
    }
        ...
        return (
            <button className={styles.gridItem} onClick={onClick}>
                <div className={styles.collage2}>
                    <div style={{ position: 'relative', flex: 1 }}><Image src={firstPhoto!} alt="" className={styles.colImg} fill style={{ objectFit: 'cover' }} /></div>
                    <div style={{ position: 'relative', flex: 1 }}><Image src={secondPhoto!} alt="" className={styles.colImg} fill style={{ objectFit: 'cover' }} /></div>
                </div>
            </button>
        );
    }
        ...
        return (
            <button className={styles.gridItem} onClick={onClick}>
                <div className={styles.collage3}>
                    <div style={{ position: 'relative', flex: 2 }}><Image src={firstPhoto!} alt="" className={`${styles.colImg} ${styles.colBig}`} fill style={{ objectFit: 'cover' }} /></div>
                    <div className={styles.colStack}>
                        <div style={{ position: 'relative', flex: 1 }}><Image src={secondPhoto!} alt="" className={styles.colImg} fill style={{ objectFit: 'cover' }} /></div>
                        <div style={{ position: 'relative', flex: 1 }}><Image src={thirdPhoto!} alt="" className={styles.colImg} fill style={{ objectFit: 'cover' }} /></div>
                    </div>
                </div>
            </button>
        );
    ...
    return (
        <button className={styles.gridItem} onClick={onClick}>
            <div className={styles.collage4}>
                <div style={{ position: 'relative' }}><Image src={firstPhoto!} alt="" className={styles.colImg} fill style={{ objectFit: 'cover' }} /></div>
                <div style={{ position: 'relative' }}><Image src={secondPhoto!} alt="" className={styles.colImg} fill style={{ objectFit: 'cover' }} /></div>
                <div style={{ position: 'relative' }}><Image src={thirdPhoto!} alt="" className={styles.colImg} fill style={{ objectFit: 'cover' }} /></div>
                <div className={styles.colImgWrap} style={{ position: 'relative' }}>
                    <Image src={fourthPhoto!} alt="" className={styles.colImg} fill style={{ objectFit: 'cover' }} />
                    {extra > 0 && (

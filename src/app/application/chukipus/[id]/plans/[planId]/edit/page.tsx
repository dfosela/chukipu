...
export default function EditPlanPage({ params }: { params: Promise<{ id: string; planId: string }> }) {
    ...
    if (loading) {
        return (
            <div className={styles.container}>
                <div className={styles.header}>{backBtn}<h1 className={styles.headerTitle}>Cargando...</h1><div className={styles.spacer38} /></div>
            </div>
        );
    }
    ...
    if (!plan) {
        return (
            <div className={styles.container}>
                <div className={styles.header}>{backBtn}<h1 className={styles.headerTitle}>Error</h1><div className={styles.spacer38} /></div>
    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                {backBtn}
                <h1 className={styles.headerTitle}>Editar Plan</h1>

...
function CreateForm() {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            const chukipuData: Record<string, unknown> = {
                name: name.trim(),
                image: imageUrl,
                createdBy: user.uid,
                members: [user.uid],
            ...
            if (isPrivate) {
                chukipuData.isPrivate = true;
            } else {
                chukipuData.inviteCode = generateInviteCode();
            }

            await firebaseBatchUpdate({
                [`chukipus/${chukipuId}`]: chukipuData,
        ...
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <h1 className={styles.title}>
                    {isPrivate ? 'Chukipu privado' : 'Chukipu compartido'}
                </h1>
            ...
            <div className={styles.content}>
                ...
                <h2 className={styles.subtitle}>
                    {isPrivate ? 'Dale un nombre a tu espacio' : 'Dale un nombre a vuestro espacio'}
                </h2>
                <p className={styles.hint}>
                    {isPrivate ? 'Solo tú lo verás' : 'Puede ser algo especial entre vosotros'}
                </p>
...
export default function NuevoChukipuCreatePage() {
    return (
        <Suspense>
            <CreateForm />
        </Suspense>
